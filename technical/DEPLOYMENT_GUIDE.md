...
🛡️ Policy seeded: /tmp/undc-deny-test → DENY
...
| Version | Date | Change |
|---|---|---|
| 1.0.0 | August 19, 2026 | Initial guide. Described Phase 1 and Phase 2 as operational. Presented sample output from tests that had not been run. |
| 1.1.0 | September 16, 2026 | Rewritten to separate implemented components (schema validation, ZK pipeline, LSM hook on `bprm_check_security`) from designed components (Docker build gates, DaemonSet, `socket_connect` hook, OCI hook, admission webhook). Removed fabricated test output. |
