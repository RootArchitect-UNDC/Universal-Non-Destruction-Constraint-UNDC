...
If you're new to the grid, start here:
1. Download the repository.
2. Run `python verify_sentinel.py`.
3. You are now a sentinel.
...
The UNDC welcomes contributions to:
- Mathematical invariants (core rules)
- Implementation software (middleware, tools, schemas)

The following are **not** open for contribution:
- Core licensing (Apache 2.0 / CC BY-NC-ND 4.0)
- The sovereign record (Evidence Manifest, hashes, anchors)
- The Architect's final authority over the framework

All contributions are subject to review and final approval by the Lead Architect.
...
Before submitting a pull request, please review the [Evidence Manifest](EVIDENCE_MANIFEST.md) to understand the sovereign record.
